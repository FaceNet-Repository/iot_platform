...
@Component({
  selector: 'tb-permission-table-header',
  templateUrl: './permission-table-header.component.html',
  styleUrls: []
})
export class PermissionTableHeaderComponent extends EntityTableHeaderComponent<PermissionInfo> {
