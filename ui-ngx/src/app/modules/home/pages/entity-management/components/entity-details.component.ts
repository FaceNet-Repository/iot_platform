...
import {AttributeService, DeviceService, EntityRelationService} from '@app/core/public-api';
...
export class EntityDetailsComponent implements OnChanges {
  ...
  loadAttributes(entity: Asset, scope: AttributeScope = AttributeScope.SERVER_SCOPE) {
