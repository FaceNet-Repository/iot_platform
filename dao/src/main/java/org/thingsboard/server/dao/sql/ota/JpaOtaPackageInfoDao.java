...
public class JpaOtaPackageInfoDao extends JpaAbstractDao<OtaPackageInfoEntity, OtaPackageInfo> implements OtaPackageInfoDao {
    ...
    @Override
    public OtaPackageInfo findOtaPackageByTitleAndVersion(String title, String version) {
        return DaoUtil.getData(otaPackageInfoRepository.findOtaPackageByTitleAndVersion(title, version));
    }
